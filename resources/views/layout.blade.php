                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i>giadungviet@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__language">
                                <image src="{{asset('/frontend/image/language1.png')}}" with="20px" height="20px" alt="">
                                <div>{{__('Ngôn Ngữ')}}</div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="footer__about">
                        ...
                        <div class="footer__about__logo">
                            <a href="{{URL::to('/trang-chu')}}"><image width="300" height="150" src="{{asset('/upload/contact/'.$ci->info_logo)}}" alt=""></a>
                        </div>
                        <ul>
