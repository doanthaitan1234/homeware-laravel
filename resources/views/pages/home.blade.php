        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="{{asset('upload/slider/'.$slider->slider_image)}}">
                                ...
                                <div class="shipping_list d-flex justify-content-between" style="">
                                    <div class="single_shipping_box d-flex">
                                        <div class="shipping_icon">
                                            <img src="{{asset('frontend/image/ship/1.png')}}" alt="shipping icon">
                                        </div>
                                    ...
                                    <div class="single_shipping_box one d-flex ">
                                        <div class="shipping_icon">
                                            <img src="{{asset('frontend/image/ship/2.png')}}" alt="shipping icon">
                                        </div>
                                        <div class="shipping_content">
                                    ...
                                    <div class="single_shipping_box d-flex">
                                        <div class="shipping_icon">
                                            <img src="{{asset('frontend/image/ship/4.png')}}" alt="shipping icon">
                                        </div>
                                        <div class="shipping_content">
            ...
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <form>
                        ...
                        <div class="categories__item set-bg" data-setbg="{{asset('upload/product/'.$sold->product_image)}}">
                            <?php
                                $language = Session::get('language');
                                if ($language == 'en') {
                                    ?>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 mix">
                    <div class="featured__item">
                      <form>
                        ...
                        <div class="featured__item__pic set-bg" data-setbg="{{asset('upload/product/'.$product->product_image)}}">
                           <img id="wishlist_productimage{{$product->product_id}}" src ="{{asset('upload/product/'.$product->product_image)}}">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <a href="{{$ads->ads_link}}"><img width="500" height="250" href="#" src="{{asset('upload/qc/'.$ads->ads_image)}}" alt="{{$ads->ads_desc}}"></a>
                    </div>
                </div>
                @endforeach
            </div>
                        ...
                        <div class="latest-product__slider owl-carousel">
                            ...
                            <div class="latest-prdouct__slider__item">
                               <a href="{{URL::to('chi-tiet-san-pham/'.$sold->product_slug)}}" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{asset('upload/product/'.$sold->product_image)}}" alt="">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <?php
                                        $language = Session::get('language');
                        ...
                        <div class="latest-product__slider owl-carousel">
                            ...
                            <div class="latest-prdouct__slider__item">
                                <a href="{{URL::to('chi-tiet-san-pham/'.$price->product_slug)}}" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{asset('upload/product/'.$price->product_image)}}" alt="">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <?php
                                        $language = Session::get('language');
